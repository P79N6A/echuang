...
define('ADMIN_MODULES_SYSTEM_CENTER', 'modules/system_center');
define('ADMIN_MODULES_MEMBER_CENTER', 'modules/member_center');
// define('ADMIN_MODULES_FINANCE_CENTER', 'modules/finance_center');
define('ADMIN_MODULES_SERVICE_CENTER', 'modules/service_center');
//define('ADMIN_MODULES_RED_ENVELOPES', 'modules/red_envelopes');抢红包
define('ADMIN_MODULES_SYSTEM', 'modules/system');
define('ADMIN_MODULES_SHOP', 'modules/shop');
//define('ADMIN_MODULES_CMS', 'modules/cms');资讯
 ...
 * 分类图片
 */
define('CATEGROY_IMAGES_EXT', '_20,_60,_240,_360,_1280');
/**
 *  订单状态
 */
//已取消
...
define('MEMBER_SYSTEM_LOGIN_SITE_URL', $config['member_system_site_url']);
define('BASE_DATA_PATH', BASE_ROOT_PATH . '/data');
...
define('MEMBER_SYSTEM_SITE_URL', $config['member_system_site_url']);
...
require_once BASE_CORE_PATH . '/framework/function/categroy.php';
