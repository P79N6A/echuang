...
class seller_goodsControl extends mobileSellerControl {
    ...
    public function goods_addOp() {
        ...
        if(!$result['state']) {
			...
			$_POST['img']=$img;
			 $rs = $logic_goods->editSaveImage($img,$result['data'], $this->seller_info['store_id'], $this->seller_info['seller_id'], $this->seller_info['seller_name']);
		}
    ...
    public function goods_editOp() {
		...
		if(count($imageall)>0){
			...
			$_POST['img']=$img;
			 $rs = $logic_goods->editSaveImage($img, $_POST['commonid'], $this->seller_info['store_id'], $this->seller_info['seller_id'], $this->seller_info['seller_name']);
		}
