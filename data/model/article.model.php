...
class articleModel extends Model {
    ...
    public function getApiArticleList($condition,$field='article_time,article_image,article_id,article_title,article_content,article_url',$order = 'article_time desc', $limit = 0, $page = 10, $count = 0) {
        return $this
            ->table('article')
            ->field($field)
            ->where($condition)
