...
class cacheModel extends Model {
	...
	private function _admin_menu() {
		...
		if (file_exists(BASE_PATH . DS . ADMIN_MODULES_SYSTEM_CENTER . '/include/menu.php')) {
			require BASE_PATH . DS . ADMIN_MODULES_SYSTEM_CENTER . '/include/menu.php';
		}
		if (file_exists(BASE_PATH . DS . ADMIN_MODULES_MEMBER_CENTER . '/include/menu.php')) {
			require BASE_PATH . DS . ADMIN_MODULES_MEMBER_CENTER . '/include/menu.php';
		}
		// if (file_exists(BASE_PATH.DS.ADMIN_MODULES_FINANCE_CENTER.'/include/menu.php')) {
		//     require(BASE_PATH.DS.ADMIN_MODULES_FINANCE_CENTER.'/include/menu.php');
		// }
        if (file_exists(BASE_PATH . DS . ADMIN_MODULES_SERVICE_CENTER . '/include/menu.php')) {
            require BASE_PATH . DS . ADMIN_MODULES_SERVICE_CENTER . '/include/menu.php';
        }
        if (file_exists(BASE_PATH . DS . ADMIN_MODULES_RED_ENVELOPES . '/include/menu.php')) {
            require BASE_PATH . DS . ADMIN_MODULES_RED_ENVELOPES . '/include/menu.php';
        }
		...
		if (file_exists(BASE_PATH . DS . ADMIN_MODULES_DECLARATION_FROM . '/include/menu.php')) {
			require BASE_PATH . DS . ADMIN_MODULES_DECLARATION_FROM . '/include/menu.php';
		}
		// if (file_exists(BASE_PATH . DS . ADMIN_MODULES_MEMBER_SYSTEM . '/include/menu.php')) {
		// 	require BASE_PATH . DS . ADMIN_MODULES_MEMBER_SYSTEM . '/include/menu.php';
		// }
