...
// require_once dirname(dirname(__FILE__)) . DS . 'AopSdk.php';
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . './../../../aop/request/AlipayTradePagePayRequest.php';
// require_once dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'AlipayTradePagePayRequest.php';
