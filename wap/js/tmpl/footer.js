$(function() {
    ...
    //     '<div class="nav-text">';
    // if (key) {
    //     html += '<a href="' + WapSiteUrl + '/tmpl/member_system/center.html">会员系统</a>' +
    ...
    //         '<a href="' + WapSiteUrl + '/tmpl/article_list.html?ac_id=2">帮助</a>';
    // }
    // html += '<a href="javascript:void(0);" class="gotop">返回顶部</a>' + "</div>" + '<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2017-2018 <a href="javascript:void(0);">redbag商城 www.szbeilaid.com</a>版权所有' + "</div></div>";
    ...
    if (cart_count > 0) {
        var fnav = '<div id="footnav" class="footnav clearfix"><ul>' +
            ...
            '<li><a href="' + WapSiteUrl + '/tmpl/news.html"><i class="news"></i><p>新闻</p></a></li>'+
            '<li><a href="' + WapSiteUrl + '/tmpl/cart_list.html"><span id="cart_count"><i class="cart"></i><sup>' + cart_count + '</sup></span><p>购物车</p></a></li>' +
            '<li><a href="' + WapSiteUrl + '/tmpl/member_system/center.html"><i class="member"></i><p>我</p></a></li></ul>' +
            '</div>';
    } else {
        var fnav = '<div id="footnav" class="footnav clearfix"><ul>' +
            '<li><a href="' + WapSiteUrl + '"><i class="home"></i><p>首页</p></a></li>' +
            '<li><a href="' + WapSiteUrl + '/tmpl/product_first_categroy.html?gc_id=1118"><i class="categroy"></i><p>分类</p></a></li>' +
            '<li><a href="' + WapSiteUrl + '/tmpl/news.html"><i class="news"></i><p>新闻</p></a></li>'+
