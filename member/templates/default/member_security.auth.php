    ...
    <form method="post" id="auth_form" action="index.php?act=member_security&op=auth">
      ...
      <dl>
        ...
        <dd>
         ...
         <img src="index.php?act=seccode&op=makecode&type=30,92&nchash=<?php echo getNchash();?>" name="codeimage" border="0" w id="codeimage" class="ml5 vt"><a href="javascript:void(0)" class="ml5 blue" onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&type=30,92&nchash=<?php echo getNchash();?>&t=' + Math.random();">看不清？换张图</a>
...
$(function(){
	$('.submit').on('click',function(){
		if (!$('#auth_form').valid()){
			document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&type=30,92&nchash=<?php echo getNchash();?>&t=' + Math.random();
		} else {
			$('#auth_form').submit();
		}
	});
