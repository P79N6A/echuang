        ...
        <dd>
          <ul>
            ...
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6)); ?>"><?php echo $lang['hao_custom']; ?></a></li>
              <li><a rel="nofollow" href="<?php echo urlShop('seller_login','show_login');?>" target="_self"><i class="i_ico06"></i>商家中心</a></li>
          </ul>
        </dd>
      </dl>
<!--      <dl>-->
...
<!--            </ul>-->
    ...
    <div class="user-entry">
      ...
      <span><a href="<?php echo urlMemberSystem('member_info', 'index'); ?>" style="color: red;">进入会员系统</a></span>
    <?php endif?>
