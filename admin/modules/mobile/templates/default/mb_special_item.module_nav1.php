...
<!--            <input id="home1_title" type="text" class="txt w200" name="item_data[title]" value="--><?php //echo $item_data['title']; ?><!--">-->
    ...
    <div class="content">
        ...
        <div class="nav1_1">
            ...
            <div nctype="item_image" class="item"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['square_image'][8]); ?>" alt="">
                <?php if ($item_edit_flag) {?>
                    <input nctype="image_name" name="item_data[square_image][]" type="hidden" value="<?php echo $item_data['square_image'][8]; ?>">
                    <input nctype="image_type" name="item_data[square_type][]" type="hidden" value="<?php echo $item_data['square_type'][8]; ?>">
                    <input nctype="image_data" name="item_data[square_data][]" type="hidden" value="<?php echo $item_data['square_data'][8]; ?>">
                    <input nctype="image_title" name="item_data[square_title][]" type="hidden" value="<?php echo $item_data['square_title'][8]; ?>">
                    <a nctype="btn_edit_item_image" data-desc="48*48" href="javascript:;"><i class="fa fa-pencil-square-o"></i>编辑</a>
                <?php }?>
            </div>
            <div nctype="item_image" class="item"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['square_image'][9]); ?>" alt="">
                <?php if ($item_edit_flag) {?>
                    <input nctype="image_name" name="item_data[square_image][]" type="hidden" value="<?php echo $item_data['square_image'][9]; ?>">
                    <input nctype="image_type" name="item_data[square_type][]" type="hidden" value="<?php echo $item_data['square_type'][9]; ?>">
                    <input nctype="image_data" name="item_data[square_data][]" type="hidden" value="<?php echo $item_data['square_data'][9]; ?>">
                    <input nctype="image_title" name="item_data[square_title][]" type="hidden" value="<?php echo $item_data['square_title'][9]; ?>">
                    <a nctype="btn_edit_item_image" data-desc="48*48" href="javascript:;"><i class="fa fa-pencil-square-o"></i>编辑</a>
                <?php }?>
            </div>
        </div>
