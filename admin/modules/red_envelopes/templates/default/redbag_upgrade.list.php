...
<script type="text/javascript">
    ...
    $('#ncsubmit').click(function() {
        $("#flexigrid").flexOptions({ url: 'index.php?act=member_upgrade&op=get_xml&' + $("#formSearch").serialize(), query: '', qtype: '' }).flexReload();
    });

    // 高级搜索重置
    $('#ncreset').click(function() {
        $("#flexigrid").flexOptions({ url: 'index.php?act=member_upgrade&op=get_xml' }).flexReload();
        $("#formSearch")[0].reset();
    });
