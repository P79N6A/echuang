    ...
    <form id="bank_form" enctype="multipart/form-data" method="post" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="site_name" name="interest_name" value="" class="input-txt1" type="text" />
                </dd>
            </dl>
            <div class="bot">
                <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" onclick="document.form1.submit()">
                    提交
                </a>
            </div>
        </div>
