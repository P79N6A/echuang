...
<div class="page">
    ...
    <script type="text/javascript">
        $(function(){
            $("#flexigrid").flexigrid({
                url: 'index.php?act=merchant_entry&op=get_xml',
                colModel : [
                    {display: '操作', name : 'operation', width : 250, sortable : true, align: 'center'},
                    ...
                    {display: '店名', name : 'title', width : 100, sortable : true, align: 'center'},
                    {display: '地址', name : 'address', width : 150, sortable : true, align: 'center'},
                    {display: '电话', name : 'mobile', width : 100, sortable : true, align: 'center'},
                    {display: '分类', name : 'classify', width : 50, sortable : true, align: 'center'},
                    {display: '内容', name : 'content', width : 200, sortable : true, align: 'center'},
                    {display: '营业执照', name : 'licence', width : 100, sortable : true, align: 'center'},
                    {display: '门店图片', name : 'store', width : 100, sortable : true, align: 'center'},
                    {display: '申请时间', name : 'addtime', width : 150, sortable : true, align: 'center'}
                ],
                buttons : [
