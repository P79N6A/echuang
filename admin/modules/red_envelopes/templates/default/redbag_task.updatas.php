    ...
    <form id="bank_form" enctype="multipart/form-data" method="post" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="title" name="title" value="<?php echo $output['result']['task_title']?>" class="input-txt1" type="text" />
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                ...
                <dd class="opt">
                    <input id="task_number" name="number" value="<?php echo $output['result']['task_number']?>" class="input-txt1" type="text" />
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                ...
                <dd class="opt">
                    <input id="quantity_received" name="content" value="<?php echo $output['result']['task_content']?>" class="input-txt1" type="text" />
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="task_number" name="total_sum" value="<?php echo $output['result']['task_total_sum']?>" class="input-txt1" type="text" />
                </dd>
            </dl>
            <div class="bot">
