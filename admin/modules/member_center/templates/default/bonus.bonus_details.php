...
$(function() {
    $("#flexigrid").flexigrid({
        ...
        colModel: [
            ...
            { display: '积分', name: 'variable_integral', width: 100, sortable: false, align: 'center' },
            { display: '调整后积分总额', name: 'stable_integral', width: 160, sortable: true, align: 'center' },
            { display: '预期积分', name: 'variable_estimate_integral', width: 100, sortable: false, align: 'center' },
            { display: '调整后预期积分总额', name: 'stable_estimate_integral', width: 160, sortable: true, align: 'center' },
