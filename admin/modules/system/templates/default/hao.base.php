...
<!--      <dl class="row">
        <dt class="tit">
          <label for="hao_qq"><?php echo $lang['hao_qq'];?></label>
        </dt>-->
<!--        <dd class="opt">-->
<!--          <input id="hao_qq" name="hao_qq" value="<?php// echo $output['list_setting']['hao_qq'];?>" class="input-txt" type="text" />-->
<!--          <p class="notic"><?php //echo $lang['hao_qq_notice'];?></p>-->
<!--        </dd>-->
<!--      </dl> -->    
            <dl class="row">
        <dt class="tit">
