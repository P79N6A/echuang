    ...
    <div class="ncap-form-default">
     <dl class="row">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input id="hao_sms_pw" name="hao_sms_pw" value="<?php echo $output['list_setting']['hao_sms_pw'];?>" class="input-txt" type="password" />
        ...
        <dd class="opt">
          <input id="hao_sms_key" name="hao_sms_key" value="<?php echo $output['list_setting']['hao_sms_key'];?>" class="input-txt" type="password" />
