    ...
    <form id="bank_form" enctype="multipart/form-data" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?php echo $output['bank_info']['bank_name']; ?>" name="bank_name" id="bank_name" class="input-txt">
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="bank_abbreviation" id="bank_abbreviation" class="input-txt" value="<?php echo $output['bank_info']['bank_abbreviation']; ?>">
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <img id="my_pic" src="<?php echo $output['bank_info']['bank_logo']; ?>" width="30" height="30">
                    <input type="hidden" name="bank_logo" id="bank_logo" value="<?php echo $output['bank_info']['bank_logo']; ?>">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <label>
                        <input type="radio" <?php echo ($output['bank_info']['bank_state'] == 1) ? 'checked' : ''; ?> value="1" name="bank_state"> 支持
                    </label>
                    <label style="margin-left: 30px;">
                        <input type="radio" <?php echo ($output['bank_info']['bank_state'] == 0) ? 'checked' : ''; ?> value="0" name="bank_state"> 不支持
                    </label>
                    <p class="notic"></p>
                </dd>
            </dl>
