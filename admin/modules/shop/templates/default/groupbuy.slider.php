    ...
    <form id="live_form" method="post" enctype="multipart/form-data">
        ...
        <div class="ncap-form-default">
            ...
            <input type='button' name='button1' id='button1' value='选择上传...' class='type-file-button' />
                    ...
                    <p class="notic">请使用宽度970像素，高度300像素的jpg/gif/png格式图片作为幻灯片banner上传，
                        <br/> 如需跳转请在后方添加以http://开头的链接地址。
                    </p>
                </dd>
            </dl>
            <dl class="row">
            ...
            <input type='button' name='button2' id='button2' value='选择上传...' class='type-file-button' />
                    ...
                    <input class="input-txt m15" type="text" name="live_color2" value="<?php echo $output['list_setting']['live_color2'] ?>" placeholder="请输入幻灯背景颜色" />
                    <p class="notic">请使用宽度970像素，高度300像素的jpg/gif/png格式图片作为幻灯片banner上传，
                        <br/> 如需跳转请在后方添加以http://开头的链接地址。
                    </p>
                </dd>
            ...
            <input type='button' name='button3' id='button3' value='选择上传...' class='type-file-button' />
                    ...
                    <input class="input-txt m15" type="text" name="live_color3" value="<?php echo $output['list_setting']['live_color3'] ?>" placeholder="请输入幻灯背景颜色" />
                    <p class="notic">请使用宽度970像素，高度300像素的jpg/gif/png格式图片作为幻灯片banner上传，
                        <br/> 如需跳转请在后方添加以http://开头的链接地址。
                    </p>
                </dd>
            ...
            <input type='button' name='button4' id='button4' value='选择上传...' class='type-file-button' />
                    ...
                    <input class="input-txt m15" type="text" name="live_color4" value="<?php echo $output['list_setting']['live_color4'] ?>" placeholder="请输入幻灯背景颜色" />
                    <p class="notic">请使用宽度970像素，高度300像素的jpg/gif/png格式图片作为幻灯片banner上传，
                        <br/> 如需跳转请在后方添加以http://开头的链接地址。
                    </p>
                </dd>
            ...
            <div class="bot">
                ...
                </a> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-red ml10" id="clearBtn">清空数据</a></div>
        </div>
    </form>
</div>
