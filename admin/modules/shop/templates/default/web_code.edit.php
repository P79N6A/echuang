  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li><?php echo $lang['web_config_edit_help3'];?></li>
	   <li><?php echo $lang['web_config_edit_help4'];?></li>
    </ul>
  </div>
   ...
   <!--       <div class="hao-btbrand"><dl>
              ...
              <dd>
                <ul class="brands">
                  ...
                  <li><span><?php echo $val['brand_name'];?></span></li>
                  <?php } ?>
                  <?php }else { ?>
              ...
              <dl recommend_id="<?php echo $key;?>">
                ...
                <dd>
                  ...
                  <div class="middle-banner">
					  <a href="javascript:void(0);" class="left-a"><img pic_url="<?php echo $val['pic_list']['11']['pic_url'];?>" title="<?php echo $val['pic_list']['11']['pic_name'];?>" stitle="<?php echo $val['pic_list']['11']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['11']['pic_img'];?>"/></a>
					  <a href="javascript:void(0);" class="left-b"><img pic_url="<?php echo $val['pic_list']['12']['pic_url'];?>" title="<?php echo $val['pic_list']['12']['pic_name'];?>" stitle="<?php echo $val['pic_list']['12']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['12']['pic_img'];?>"/></a>
					  <a href="javascript:void(0);" class="left-c"><img pic_url="<?php echo $val['pic_list']['31']['pic_url'];?>" title="<?php echo $val['pic_list']['31']['pic_name'];?>" stitle="<?php echo $val['pic_list']['31']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['31']['pic_img'];?>"/></a>
					  <a href="javascript:void(0);" class="left-d"><img pic_url="<?php echo $val['pic_list']['32']['pic_url'];?>" title="<?php echo $val['pic_list']['32']['pic_name'];?>" stitle="<?php echo $val['pic_list']['32']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['32']['pic_img'];?>"/></a>
					  <a href="javascript:void(0);" class="left-e"><img pic_url="<?php echo $val['pic_list']['33']['pic_url'];?>" title="<?php echo $val['pic_list']['33']['pic_name'];?>" stitle="<?php echo $val['pic_list']['33']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['33']['pic_img'];?>"/></a>
					  <a href="javascript:void(0);" class="left-f"><img pic_url="<?php echo $val['pic_list']['34']['pic_url'];?>" title="<?php echo $val['pic_list']['34']['pic_name'];?>" stitle="<?php echo $val['pic_list']['34']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['34']['pic_img'];?>"/></a>
				  </div>
                  <?php }else { ?>
                  <ul class="goods-list">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt" id="add_recommend_pic">
          ...
          <a recommend_pic_id="31" href="javascript:void(0);" class="left-c"><img pic_url="<?php echo $val['pic_list']['31']['pic_url'];?>" title="<?php echo $val['pic_list']['31']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['31']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['31']['pic_img'];?>" stitle="<?php echo $val['pic_list']['31']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['31']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="32" href="javascript:void(0);" class="left-d"><img pic_url="<?php echo $val['pic_list']['32']['pic_url'];?>" title="<?php echo $val['pic_list']['32']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['32']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['32']['pic_img'];?>" stitle="<?php echo $val['pic_list']['32']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['32']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="33" href="javascript:void(0);" class="left-e"><img pic_url="<?php echo $val['pic_list']['33']['pic_url'];?>" title="<?php echo $val['pic_list']['33']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['33']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['33']['pic_img'];?>" stitle="<?php echo $val['pic_list']['33']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['33']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="34" href="javascript:void(0);" class="left-f"><img pic_url="<?php echo $val['pic_list']['34']['pic_url'];?>" title="<?php echo $val['pic_list']['34']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['34']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['34']['pic_img'];?>" stitle="<?php echo $val['pic_list']['34']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['34']['pic_sname'];?>"/></a></div>
          <?php } ?>
          <?php } ?>
          <?php } ?>
        </dd>
