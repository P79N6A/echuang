...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=cms_special&op=cms_special_save">
    <input name="special_id" type="hidden" value="<?php if (!empty($output['special_detail'])) {
	echo $output['special_detail']['special_id'];
}
?>" />
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input id="special_title" name="special_title" class="input-txt" type="text" value="<?php if (!empty($output['special_detail'])) {
	echo $output['special_detail']['special_title'];
}
?>"/>
          <span class="err"></span>
       ...
       <dl class="row">
        ...
        <dd class="opt">
          <input id="special_stitle" name="special_stitle" class="input-txt" type="text" value="<?php if (!empty($output['special_detail'])) {
	echo $output['special_detail']['special_stitle'];
}
?>"/>
          <span class="err"></span>
          <p class="notic"><?php echo $lang['cms_special_title_explain']; ?></p>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input class="txt" name="special_background_color" type="color" value="<?php if (!empty($output['special_detail'])) {
...
?>" />
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <label class="mr10">
            <input name="special_repeat" type="radio" value="no-repeat" <?php if ($output['special_detail']['special_repeat'] == 'no-repeat') {
	echo 'checked';
}
?> />
            <?php echo $lang['cms_special_background_type_norepeat']; ?></label>
          <label class="mr10">
            <input name="special_repeat" type="radio" value="repeat" <?php if ($output['special_detail']['special_repeat'] == 'repeat') {
	echo 'checked';
}
?>/>
            <?php echo $lang['cms_special_background_type_repeat']; ?></label>
          <label class="mr10">
            <input name="special_repeat" type="radio" value="repeat-x" <?php if ($output['special_detail']['special_repeat'] == 'repeat-x') {
	echo 'checked';
}
?>/>
            <?php echo $lang['cms_special_background_type_xrepeat']; ?></label>
          <label class="mr10">
            <input name="special_repeat" type="radio" value="repeat-y" <?php if ($output['special_detail']['special_repeat'] == 'repeat-y') {
	echo 'checked';
}
?>/>
