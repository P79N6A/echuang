...
class form_system_editControl extends SystemControl
{
    ...
    public function income_settingOp() {
        ...
        if (chksubmit()) {
            $data = array();
            $data['f_declaration_time'] = intval(trim($_POST['f_declaration_time']));
            $data['f_recommend_num'] = intval(trim($_POST['f_recommend_num']));
            $data['f_reward_integral'] = intval(trim($_POST['f_reward_integral']));
            $data['f_cycle_time'] = intval(trim($_POST['f_cycle_time']));
            $data['f_cycle_num'] = intval(trim($_POST['f_cycle_num']));
