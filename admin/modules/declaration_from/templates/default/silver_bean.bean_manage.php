            ...
            <div id="searchCon" class="content">
                <div class="layout-box">
                    ...
                    <dl>
                        <dt>银豆类型</dt>
                        <label>
                            <select name="silver_type" class="s-select">
...
$(function() {
    $("#flexigrid").flexigrid({
        url: 'index.php?act=silver_bean&op=get_xml',
        colModel: [
            { display: '会员手机', name: 'member_mobile', width: 100, sortable: false, align: 'center' },
            { display: '会员姓名', name: 'slg_member_name', width: 100, sortable: false, align: 'center' },
            { display: '单号', name: 'slg_sn', width: 160, sortable: false, align: 'center' },
            { display: '银豆类型', name: 'slg_type', width: 100, sortable: false, align: 'center' },
            { display: '金额', name: 'slg_amount', width: 100, sortable: false, align: 'center' },
            { display: '调整后金额', name: 'slg_bean_amount', width: 160, sortable: false, align: 'center' },
            { display: '时间', name: 'slg_addtime', width: 160, sortable: false, align: 'center' },
            { display: '备注', name: 'slg_desc', width: 460, sortable: false, align: 'center' },
        ],
        buttons: [
        ...
        searchitems: [
            ...
            { display: '会员姓名', name: 'slg_member_name' },
            { display: '单号', name: 'slg_sn' },
...
$('#ncsubmit').click(function() {
    $("#flexigrid").flexOptions({ url: 'index.php?act=silver_bean&op=get_xml&' + $("#formSearch").serialize(), query: '', qtype: '' }).flexReload();
});

// 高级搜索重置
$('#ncreset').click(function() {
    $("#flexigrid").flexOptions({ url: 'index.php?act=silver_bean&op=get_xml' }).flexReload();
    $("#formSearch")[0].reset();
});
