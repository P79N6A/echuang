  ...
  <div class="content">
    <div class="scroll switchbox" >
      <ul class="tema">
        <li>
          <h4>源码提供 - 商城</h4>
          <p>唯一官方网：<a href="http://www.xxx.com" target="_blank">http://www.xxx.com</a></p>
          <p>唯一淘宝店：<a href="http://www.xxx.com" target="_blank">http://xxx.taobao.com</a></p>
    ...
    <div class="scrollbar switchbox" style="display: none;">
      <div class="law-notice">
        <p>程序来源：商城网店交流中心 <a href="http://www.xxx.com" target="_blank">http://www.xxx.com</a>。</p>
          感谢您选择商城B2B2C电商平台系统。希望我们的努力能为您提供一个高效快速和强大的企业级电子商务整体解决方案。</p>
        <p>商城B2B2C系统是根据网络电商系统进化而来！本版本只用户学习和研究，您使用过程中产生的利益与本商城无关，我们不负任何法律责任！</p>
        <p>尊爱网络环境！禁止非法传播。</p>
      </div>
    </div>
    <div class="switchbox" style="display:none;" >
      <ul>
        ...
        <li>
          <h4>关注我们</h4>
          <p><?php echo $lang['dashboard_aboutus_website'];?> <a href="http://www.xxx.com" target="_blank">http://www.xxx.com</a></p>
