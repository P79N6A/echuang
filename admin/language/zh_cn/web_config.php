...
$lang['web_config_edit_help4']			= '楼层中部的轮播图只有在商品推荐选择广告块才会在商城首页显示出来，如果选择商品块则不显示。';
...
$lang['web_config_upload_act_tips']			= '建议上传宽212*高212像素GIF\JPG\PNG格式图片，超出规定范围的图片部分将被自动隐藏。';
...
$lang['web_config_upload_pic_tips']			= '建议上传宽420*高358像素GIF\JPG\PNG格式图片，超出规定范围的图片部分将被自动隐藏。';
