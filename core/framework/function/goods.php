...
function orderPaymentName($payment_code) {
	return str_replace(
		array('offline', 'online', 'alipay_native_app', 'ali_native', 'alipay', 'tenpay', 'chinabank', 'predeposit', 'wxpay', 'wx_jsapi', 'wx_saoma', 'chain', 'sliver_beanpay', 'beanpay', 'alipay_wap'),
		array('货到付款', '在线付款', '支付宝[移动端]', '支付宝移动支付', '支付宝', '财付通', '网银在线', '站内余额支付', '微信支付[移动端]', '微信支付[jsapi]', '微信支付[扫码]', '门店支付', '银豆支付', '金豆支付', '支付宝网页支付'),
		$payment_code);
}
