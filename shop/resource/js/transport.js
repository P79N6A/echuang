$(function(){
	...
	TransTpl += "<label><input class=\"J_BatchCheck\" type=\"checkbox\" value=\"\" name=\"\">\n";
	TransTpl += "全选<\/label>\n";
	...
	RuleHead += "<th class=\"w110\">首(件、重、体积)<\/th>\n";
	RuleHead += "<th class=\"w110\">首费(元)<\/th>\n";
	RuleHead += "<th class=\"w110\">续(件、重、体积)<\/th>\n";
	...
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"w50 text\" type=\"text\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"start\" name=\"special[TRANSTYPE][CurNum][start]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"w50 mr5 text\" type=\"text\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postage\" name=\"special[TRANSTYPE][CurNum][postage]\"><em class=\"add-on\">\n";
	RuleCell += "<i class=\"icon-renminbi\"><\/i>\n";
	RuleCell += "<\/em>\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"w50 text\" type=\"text\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"special[TRANSTYPE][CurNum][plus]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"w50 mr5 text\" type=\"text\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postageplus\" name=\"special[TRANSTYPE][CurNum][postageplus]\"><em class=\"add-on\">\n";
	RuleCell += "<i class=\"icon-renminbi\"><\/i>\n";
	RuleCell += "<\/em>\n";
	RuleCell += "<\/td>\n";
