...
class show_storeControl extends BaseStoreControl {
    ...
    public function indexOp()
    {
        ...
        $store_mem = $store_class->getStoreOnlineList(array('store_id' => $this->store_info['store_id']));
        if ($store_mem[0]['store_visual_editing'] == 0) {
...
//            $count = $model_goods->getGoodsOnlineCount($condition,"distinct goods_commonid");
////            var_dump($count);die();
//            $new_goods_list = $model_goods->getGoodsOnlineList($condition, $fieldstr, 12, 'goods_id desc', 0, 'goods_commonid', false, $count);
//
//            $condition['goods_commend'] = 1;
//            //得到12个推荐商品列表
//            $count = $model_goods->getGoodsOnlineCount($condition,"distinct goods_commonid");
//            $recommended_goods_list = $model_goods->getGoodsOnlineList($condition, $fieldstr, 12, 'goods_id desc', 0, 'goods_commonid', false, $count);
//
//            $goods_list = $this->getGoodsMore($new_goods_list, $recommended_goods_list);
//            Tpl::output('new_goods_list',$goods_list[1]);
//            Tpl::output('recommended_goods_list',$goods_list[2]);
...
//            Tpl::output('store_decoration_only', $this->store_decoration_only);
//        }
////        var_dump($recommended_goods_list);die();
//
//        Tpl::output('page','index');
//        Tpl::showpage('index');
//    }
