...
class store_goods_addControl extends BaseSellerControl {
    ...
    public function add_step_twoOp() {
        ...
        //获取当前分类的下的规格
        $type_spec_param['class_id']=$gc_id;
        $type_spec_info=Model('type')->typeInfo($type_spec_param);
        //权限组对应分类权限判断
