...
<div class="nch-breadcrumb-layout">
    <div class="nch-breadcrumb wrapper"><i class="icon-home"></i>
            <span><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=flea">闲置首页</a></span><span class="arrow">&gt;</span>
				<span><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=flea_class">全部闲置</a></span><span class="arrow">&gt;</span>
                <span><?php echo $output['goods_title'];?></span>
          </div>
  </div>
<div class="wrapper">
 ...
 <div class="share">
   ...
   <span><a href="#" class="blue" onclick="javascrit:collect_flea(<?php echo $output['goods']['goods_id'];?>);return false;"><?php echo $lang['flea_goods_collect_goods'];?></a></span>    </div>  
    ...
    <div class="content_208 fn-right">
      ...
      <p><?php echo $lang['flea_store_owner'];?>:<?php echo $output['flea_member_info']['member_name'];?><a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_message&op=sendmsg&member_id=<?php echo $output['flea_member_info']['member_id'];?>" target=_blank><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/flea/web_mail.gif"></a></p>
    </div>
        ...
        <div class="flea_goods">
           <div class="pic">
             <span class="thumb size60">
               <i></i>
               <a title="<?php echo $val['goods_name']?>" href="<?php echo SHOP_SITE_URL;?>/index.php?act=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><img height="60" width="60" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,60,60);"></a>
             </span>
           </div>
           <dl>
