...
<div id="KinSlideshow" style="visibility:hidden;">
        ...
        <a href="<?php if($val['url'] != ''){echo $val['url'];}else{echo 'javascript:void(0);';}?>" target="_blank"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_ADV.'/'.$val['pic'];?>"></a>
        <?php }?>
        <?php }?></div>
  </div>
      <div class="hotgoods">
        ...
        <div class="hotgoods_G">
          <dl>
            ...
            <dd class="fn-left"><a title="<?php echo $output['new_flea_goods']['goods_name'];?>" target="_blank" href="index.php?act=flea_goods&goods_id=<?php echo $output['new_flea_goods']['goods_id']?>"><?php echo $lang['flea_index_goods_1'];?><?php echo checkQuality($output['new_flea_goods']['flea_quality'])?><?php echo $lang['flea_index_goods_2'];?> <?php echo $output['new_flea_goods']['goods_name']?></a></dd>
