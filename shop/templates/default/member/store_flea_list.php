...
<div class="wrap">
  <div class="tabmenu">
    <?php include template('layout/submenu');?>    <a href="javascript:void(0)"  class="ncbtn ncbtn-grapefruit" onclick="go('index.php?act=member_flea&op=add_goods');" title="<?php echo $lang['store_goods_index_new_goods'];?>"><?php echo $lang['store_goods_index_new_flea'];?></a>
  </div>
