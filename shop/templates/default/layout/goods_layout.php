...
<!--        	<a href="<--><?php //echo urlShop('show_store', 'index', array('store_id'=>$output['store_info']['store_id']));?><!--" title="--><?php //echo $output['setting_config']['site_name']; ?><!--" class="store_name">--><?php //echo $output['store_info']['store_name']; ?><!--</a> <img src="--><?php //echo SHOP_TEMPLATES_URL;?><!----><?php //echo '/images/store_grade/'.$output['store_info']['grade_id'].'.png'; ?><!--" class="pngFix">-->
            <a href="<?php echo SHOP_SITE_URL;?>" title="<?php echo $output['setting_config']['site_name']; ?>" class="store_name"><?php echo $output['store_info']['store_name']; ?></a> <!--去掉上面一行，改成这一行跳转到商城首页-->
            <br>
            <span class="all-rate">
...
//                if($value['sn_if_show']) {
//      			if($value['sn_url'] != ''){?>
<!--        <li class="--><?php //if($output['page'] == $value['sn_id']){?><!--active--><?php //}else{?><!--normal--><?php //}?><!--"><a href="--><?php //echo $value['sn_url']; ?><!--" --><?php //if($value['sn_new_open']){?><!--target="_blank"--><?php //}?><!--><span></span><?php //echo $value['sn_title'];?><!--<i></i></span></a></li>-->
<!--        --><?php //}else{ ?>
