  ...
  <div class="ncm-header">
    <div class="ncm-header-top">
      <div class="ncm-member-info">
        <div class="avatar"><a href="<?php echo urlShop('member', 'home');?>" title="修改头像"><img src="<?php echo getMemberAvatar($output['member_info']['member_avatar']);?>">
          <div class="frame"></div>
          </a>
        ...
        <dl>
          <dt><a href="<?php echo urlShop('member', 'home');?>" title="修改资料"><?php echo $output['member_info']['member_name'];?></a></dt>
<!--          <dd>会员等级：-->
...
<!--      <dl class="trade-step-03">
    ...
    <div class="ncm-header-nav">
      <ul class="nav-menu">
        <li><a href="<?php echo urlShop('member', 'home');?>" class="current">我的商城订单</a></li>
