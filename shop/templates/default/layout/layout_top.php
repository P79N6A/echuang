...
<!--      </div>-->
<!--      <div class="left">-->
<!--      <a href="--><?php //echo BASE_SITE_URL; ?><!--/index.php?act=index&op=select_city&ref_url=--><?php //echo urlencode($_SERVER["REQUEST_URI"]); ?><!--" title="切换城市" class="area">当前地区：<span>--><?php //echo $output['now_city'] ?><!--</span><i></i> </a>-->
<!--      </div>-->
    </div>
...
<!--        <dt><a  href="--><?php //echo urlShop('show_joinin', 'index'); ?><!--" title="--><?php //echo $lang['hao_seller']; ?><!--">  --><?php //echo $lang['hao_seller']; ?><!--</a><i></i></dt>-->
          <dt> <?php echo $lang['hao_seller']; ?><i></i></dt>
          <dd>
          <ul>
...
<!--              <li><a href="--><?php //echo MEMBER_SITE_URL; ?><!--/index.php?act=member_points" class="arrow">--><?php //echo $lang['hao_points']; ?>
<!--              <i></i></a></li>-->
<!--              --><?php //}?>
            </ul>
          </div>
    ...
    <div class="user-entry">
      ...
      <span> <a class="home" href="<?php echo urlShop('member', 'home'); ?>"><?php echo $_SESSION['member_name']; ?></a>
