    ...
    <div class="ncsc-form-goods">
        ...
        <dl nctype="virtual_null" <?php if ($output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
            ...
            <dd>
                <ul class="ncsc-form-radio-list">
                    <li>
                        <label>
                            <input name="is_bd_product" value="1" <?php if (!empty($output['goods']) && $output['goods']['is_bd_product'] == 1) {?>checked="checked" <?php }?> type="radio" />
                            <?php echo $lang['nc_yes']; ?></label>
                    </li>
                    <li>
                        <label>
                            <input name="is_bd_product" value="0" <?php if (empty($output['goods']) || $output['goods']['is_bd_product'] == 0) {?>checked="checked" <?php }?> type="radio"/>
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="hint">价格必须是0.01~9999999之间的数字，此价格为商户对所销售的商品实际成本价格进行备注记录，必填选项，涉及到金豆返利。</p>
        </dd>
      </dl>
      <dl>
              ...
              <th class="w90"><span class="red">*</span>成本价
                <div class="batch"><i class="icon-edit" title="批量操作"></i>
                  <div class="batch-input" style="display:none;">
                    ...
                    <a href="javascript:void(0)" class="close">X</a>
                    <input name="" type="text" class="text price" />
                    <a href="javascript:void(0)" class="ncbtn-mini" data-type="costprice">设置</a><span class="arrow"></span></div>
                </div>
              </th>
          ...
          <div class="ncsc-goods-default-pic">
            <div class="goodspic-uplaod">
              <div class="upload-thumb">
                  <img nctype="goods_image" src="<?php echo thumb($output['goods'], 240); ?>"/> </div>
...
<!--                    --><?php //}?>
<!---->
<!--                <a href="JavaScript:void(0);" onclick="window.open('index.php?act=store_transport&type=select')" class="ncbtn" id="postageButton"><i class="icon-truck"></i>--><?php //echo $lang['store_goods_index_select_tpl'];?><!--</a> </div>-->
<!--            </li>-->
          </ul>
...
$(function(){
    ...
    $('#goods_form').validate({
        ...
        messages : {
            ...
            g_costprice : {
                required    : '<i class="icon-exclamation-sign"></i>请填写成本价',
                number      : '<i class="icon-exclamation-sign"></i>请填写正确的价格',
                min         : '<i class="icon-exclamation-sign"></i>请填写0.01~9999999之间的数字',
                max         : '<i class="icon-exclamation-sign"></i>请填写0.01~9999999之间的数字'
            },
...
function goods_stock_set(){
  ...
  $('input[name="g_costprice"]').attr('readonly','readonly').css('background','#E7E7E7 none');
    ...
    if(str == '<tr>'){
      ...
      $('input[name="g_marketprice"]').removeAttr('readonly','readonly').css('background','');
      $('input[name="g_costprice"]').removeAttr('readonly','readonly').css('background','');
	...
	if ($len < $sign) {
		...
		echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" nc_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td>' +
                    '<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\" data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td>' +
                     '<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][cost]\" data_type=\"costprice\" nc_type=\"'+spec_bunch+'|cost\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td>' +
