  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><?php if ($_GET['type'] == "select"){?>
        <a class="ml5 ncbtn-mini ncbtn-bittersweet" data-param="{name:'<?php echo $v['title'];?>',id:'<?php echo $v['id'];?>',trans_type:'<?php echo intval($v['goods_trans_type']);?>'}" href="javascript:void(0)"><i class="icon-truck"></i><?php echo $lang['transport_applay'];?></span></a>
