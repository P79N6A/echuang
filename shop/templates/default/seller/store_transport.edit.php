...
<div class="ncsc-form-default">
  <form method="post" id="tpl_form" name="tpl_form" action="index.php?act=store_transport&op=save">
    ...
    <dl>
      ...
      <dd>
            <label class="mr20">
              <input type="radio" class="radio vm" name="goods_fee_type" value="1" <?php if ($output['transport']['goods_fee_type'] == 1) {?>checked="checked"<?php }?> />
              买家</label>
            <label>
              <input type="radio" class="radio vm" name="goods_fee_type" value="2" <?php if ($output['transport']['goods_fee_type'] == 2) {?>checked="checked"<?php }?> />
              商家</label>
      </dd>
    </dl>
    <dl>
      ...
      <dd><?php echo $output['goods_trans_array'][$output['transport']['goods_trans_type']];?>
      </dd>
    </dl>
...
$(function(){
	...
	<?php if (is_array($output['extend'])){
	    $_type=$output['transport']['goods_trans_type'];
	    ?>
