<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="index.php?act=store_album&op=pic_list&item=des" style="display:none;"><?php echo $lang['nc_submit'];?></a>
  ...
  <ul class="list">
    ...
    <li onclick="insert_editor('<?php echo cthumb($v['apic_cover'], 1280, $_SESSION['store_id']);?>');" style="height: 120px">
        <a href="JavaScript:void(0);">
            <img src="<?php echo cthumb($v['apic_cover'], 240, $_SESSION['store_id']);?>" title='<?php echo $v['apic_name']?>'/>
        </a>
        <p style="text-align:center;font-size: 10px;margin-top: 20px;font-family: 'Microsoft Yahei', '微软雅黑'; white-space: nowrap;  text-overflow: ellipsis;"><?php echo $v['apic_name_substr']?> </p>
    </li>
    <?php }?>
  </ul>
  <?php }else{?>
