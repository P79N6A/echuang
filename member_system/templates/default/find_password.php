    ...
    <div class="nc-password-mode">
      ...
      <div id="tabs_container" class="tabs-container">
        <div id="default" class="tabs-content">
          <form class="nc-login-form" action="<?php echo urlMemberSystem('login', 'find_password');?>" method="POST" id="find_password_form">
        ...
        <div id="mobile" class="tabs-content">
          <form id="post_form" method="post" class="nc-login-form" action="<?php echo urlMemberSystem('connect_sms', 'find_password');?>">
            <?php Security::getToken();?>
            <input type="hidden" name="form_submit" value="ok" />
            <input name="nchash" type="hidden" value="<?php echo getNchash();?>" />
            <dl>
