		...
		?>
            ...
            <li>
                <dl class="s<?php echo '' . $k + 1; ?>">
                    <dt>
                        <?php if (is_array($article_class['class'])) {
			...
			?>
				...
				?>
					...
					?>
                    <dd>
                        <a href="<?php if ($article['article_url'] != '') {
						echo $article['article_url'];
					} else {
						echo urlMember('article', 'show', array('article_id' => $article['article_id']));
					}
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div><strong><?php echo $output['setting_config']['hao_phone']; ?></strong>
                            <p>
                                <?php echo $output['setting_config']['hao_time']; ?>
                            </p>
                        </div>
                    </dd>
                    <dd>
                        ...
                        <div>
                            <strong>在线客服</strong>
                            <p>E-mail：
                                <?php echo $output['setting_config']['hao_mail']; ?>
                            </p>
                        </div>
                    </dd>
                    <dl>
