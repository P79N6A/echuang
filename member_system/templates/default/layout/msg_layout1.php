...
<head>
    ...
    <meta name="author" content="Beilaide">
    <meta name="copyright" content="beilaide Inc. All Rights Reserved">
...
<![endif]-->
    ...
    var SITEURL = '<?php echo MEMBER_SYSTEM_SITE_URL; ?>';
    var MEMBER_RESOURCE_SITE_URL = '<?php echo MEMBER_RESOURCE_SITE_URL; ?>';
    var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL; ?>';
    var MEMBER_SYSTEM_TEMPLATES_URL = '<?php echo MEMBER_SYSTEM_TEMPLATES_URL; ?>';
    </script>
...
<body>
    ...
    <div class="header-wrap">
        <header class="public-head-layout wrapper">
            <h1 class="site-logo"><a href="<?php echo MEMBER_SYSTEM_SITE_URL; ?>"><img src="<?php echo UPLOAD_SITE_URL . DS . MEMBER_ATTACH_COMMON . DS . $output['setting_config']['member_system_logo']; ?>" class="pngFix"></a></h1></header>
    </div>
    <div class="msg">
