...
<!--                                <dd --><?php //if (!empty($output['seller_quicklink'])) {echo in_array($submenu_value['act'], $output['seller_quicklink']) ? 'class="selected"' : '';}?><!-->
<!--            <i nctype="btn_add_quicklink" data-quicklink-act="--><?php ////echo $submenu_value['act']; ?><!--<!--" class="icon-check" title="添加为常用功能菜单"></i>-->
...
<!--            </div>-->
    ...
    <div class="ncsc-layout wrapper">
            ...
            <div id="sidebar" class="sidebar">
                ...
                <div class="column-menu">
                    <ul id="seller_center_left_menu">
                        <?php if ($_GET['act']=="member_info") {?>

                          <?php foreach ($output['menu']['member_info']['child'] as $submenu_value) {?>
                                <li>
                                    <a href="index.php?act=<?php echo $submenu_value['act']; ?>&op=<?php echo $submenu_value['op']; ?>">
                                        <?php echo $submenu_value['name']; ?> </a>
                                </li>
                            <?php }?>
                        <?php } else if($_GET['act'] == 'member_property'){?>
                            <?php foreach ($output['menu']['property']['child'] as $submenu_value) {?>
                                <li>
                                    <a href="index.php?act=<?php echo $submenu_value['act']; ?>&op=<?php echo $submenu_value['op']; ?>">
                                        <?php echo $submenu_value['name']; ?> </a>
                                </li>
        ...
        <div id="layoutRight" class="ncsc-layout-right">
            <div class="ncsc-path"><i class="icon-desktop"></i>会员系统中心<i class="icon-angle-right"></i>
                <?php echo $output['current_menu']['model_name']; ?><i class="icon-angle-right"></i>
                <?php echo $output['current_menu']['name']; ?>
            </div>
    ...
    $(document).ready(function() {
        ...
        if(GetUrlParam("op")=="index"){
            $("#seller_center_left_menu").css("dispaly","none")
        }
        console.log(GetUrlParam("op"));
        //添加删除快捷操作
